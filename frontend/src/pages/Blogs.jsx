    ...
    <section className="flex-1 bg-[#F9F1E4] min-h-[calc(100vh-5.5rem)] sm:min-h-[calc(100vh-6.5rem)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="mt-2 sm:mt-3 font-serif text-3xl sm:text-5xl lg:text-6xl text-[#2F120F]">
            Vedic Astrology Insights
          </h1>

          <p className="mt-4 sm:mt-5 text-sm sm:text-lg leading-7 sm:leading-8 text-[#5A4A42]">
        ...
        {loading ? (
          ...
          <div className="mt-12 sm:mt-16 text-center text-red-600">
            {error}
          </div>
        ) : blogs.length === 0 ? (
          <div className="mt-12 sm:mt-16 text-center text-gray-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-10 sm:mt-16">
            {blogs.map((blog) => (
              <article
                key={blog._id}
                className="bg-[#FCF6EC] border border-[#ECDCC5] rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-md flex flex-col justify-between"
              >
                <div>
                  ...
                  <h2
                    className={`mt-3 sm:mt-4 text-xl sm:text-2xl text-[#2F120F] leading-snug ${
                      isHindi(blog.title)
                  ...
                  <p
                    className={`mt-3 sm:mt-4 text-gray-600 leading-6 sm:leading-7 line-clamp-4 text-sm sm:text-base ${
